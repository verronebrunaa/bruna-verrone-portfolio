...
export const projectsData: Project[] = [
  {
    ...
    description:
      "A back-end system for a blog application built using Java with Spring Boot.",
  ...
  },
  {
    ...
    description:
      "Um projeto de portfólio desenvolvido durante o bootcamp da Generation Brasil, utilizando HTML, CSS e JavaScript. O projeto foi desenvolvido como parte do curso de Front-End.",
